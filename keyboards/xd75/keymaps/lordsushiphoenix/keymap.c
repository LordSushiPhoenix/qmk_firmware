 ...
 */
 ...
 [_QW] = { /* QWERTY, */
  ...
  { KC_LCTL,          KC_LGUI, KC_LALT, KC_DEL,  KC_SPC,  KC_SPC,  KC_P0,   KC_PDOT, KC_SFTENT, CTL_T(KC_BSPC), GUI_T(KC_BSPC), MO(_FN),       KC_LEFT,       KC_DOWN, KC_RIGHT },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_CAPS, KC_ESC,  KC_UP,   KC_TRNS,  RGB_HUD, RGB_HUI, KC_TRNS, KC_TRNS, KC_TRNS, KC_PMNS, KC_PSLS, KC_INS,  KC_PSCR, KC_SLCK, KC_PGDN },
