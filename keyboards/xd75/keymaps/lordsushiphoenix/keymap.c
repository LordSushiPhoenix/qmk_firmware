 ...
 */
 ...
 [_QW] = { /* QWERTY, */
  { KC_GESC/*this key breaks task manager shortcut*/,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_MINS, KC_BSLS, KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_HOME  },
...
/* FUNCTION   need to fix more forgotten keys, also shift f row over to accomodate brackets
 * .--------------------------------------------------------------------------------------------------------------------------------------.
