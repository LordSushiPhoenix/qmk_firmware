 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1,   KC_P2,   KC_P3,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SLASH },
  { KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_DEL,  KC_SPC,  KC_NLCK, KC_P0,   KC_PDOT, KC_BSPC, KC_ENT,  MO(_FN), KC_RALT, KC_RGUI, KC_RCTL  },
 },
